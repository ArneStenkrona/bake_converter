...
function init() {
    ...
    unit_from.addEventListener('change', function (event) {
    ...
    unit_to.addEventListener('change', function (event) {
...
function validInput() {
    ...
    unit_from.value = unit_from.value;
    unit_to.value = unit_to.value;
    ingredient.value = ingredient.value.toLowerCase();
